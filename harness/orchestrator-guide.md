...
| Source-grounded oral drill | `수업자료 기반`, `내용 기반`, `정해진 문항 말고`, `주관식`, `백지 테스트`, `개념 설명`, `꼬리질문`, `암기 확인` | `harness/skills/source-grounded-drill/SKILL.md` |
...
9. "정해진 문항 말고" 또는 "내용 기반" 요청은 source-grounded-drill로 해석한다. 이때 approved question 파일만 반복하지 말고 source_extracted concept_note에서 즉석 주관식 질문을 만든다.
